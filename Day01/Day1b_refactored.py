def compare(calstotal, maxcals3, maxcals2,maxcals1):
    if calstotal > maxcals3:
        if calstotal > maxcals2:
            ...
            maxcals3 = calstotal
            print("Newmax",maxcals1,maxcals2,maxcals3, elfcount)
    return maxcals3, maxcals2,maxcals1

#open input file and assign to object f
f = open("Day01/input1.txt","r")
# calstotal is for a given elf
calstotal = 0
# maxcals1..3 is the top 3 greatest number of cals detected so far
maxcals1 = 0
maxcals2 = 0
maxcals3 = 0
...
for line in f:
    ...
    if line.split(): 
        ...
        elfcount += 1
        maxcals3, maxcals2,maxcals1 = compare(calstotal, maxcals3, maxcals2,maxcals1)
